function vn=get_vel_anlyt_vec_pot_cyl(~,p)

% if v_tok is 1, it will return contra variant velocity components otherwise
% normal spherical velocity components
global h_r h_theta h_z c d n_r n_theta n_z r_min theta_min z_min;
