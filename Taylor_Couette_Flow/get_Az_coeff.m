function c1=get_Az_coeff()

global vtheta h_theta h_z h_r n_r n_theta n_z dvthetadr_rmax;
...
for iz=1:n_z+1
   cr(:,itheta,iz)=spline1d_r_dfr(h_r,-vtheta(:,itheta,iz),-dvthetadr_rmax(itheta,iz));
end
end
